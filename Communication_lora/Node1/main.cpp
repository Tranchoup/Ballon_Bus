...
OneWire  ds(7);  
//NODE1 ID257
int ID_MPU_acceleration_X =  650;
int ID_MPU_acceleration_Y =  651;
int ID_MPU_acceleration_Z =  652;
int ID_Temperature_MPU = 653;
int ID_MPU_gyro_X = 654;
int ID_MPU_gyro_Y = 655;
int ID_MPU_gyro_Z = 656;
//NODE2 ID258
int ID_Magnetic_X = 657;
int ID_Magnetic_Y = 658;
int ID_Magnetic_Z = 659;
int ID_Temperature_WURTH = 660;
int ID_Pressure = 661;
int ID_Pressure_WURTH = 662;
int ID_Geiger = 663;
//Autres sur carte SD
int ID_Temperature_DS18B20 = 664;
int ID_WURTH_acceleration_X =  665;
int ID_WURTH_acceleration_Y =  666;
int ID_WURTH_acceleration_Z =  667;
int ID_Humidity_WURTH = 668;
int ID_Temperature_WURTH_HUMIDITY_SENSOR  = 669;
int ID_Temperature_WURTH_PRESSURE_SENSOR = 670;
int ID_Temperature_WURTH_INERTIAL_SENSOR = 671;
int ID_WURTH_gyro_X = 672;
int ID_WURTH_gyro_Y = 673;
int ID_WURTH_gyro_Z = 674;
